(function() {
    ...
    var width, height, canvas, ctx, lines, target, size, animateHeader = true;
    ...
    function initHeader() {
        ...
        canvas = document.getElementById('morningLight');
        canvas.width = width;
    ...
    function Line(angle) {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(0,128,128,'+(0.5+Math.random()*0.5)+')';
            ctx.fill();
